...
Get-CimInstance Win32_Processor | Select-Object LoadPercentage | Out-File -Append -FilePath $perfTxt

"=== Memoria ===" | Out-File -Append -FilePath $perfTxt
Get-CimInstance Win32_OperatingSystem | Select-Object FreePhysicalMemory, TotalVisibleMemorySize | Out-File -Append -FilePath $perfTxt

"=== Disco ===" | Out-File -Append -FilePath $perfTxt
Get-CimInstance Win32_LogicalDisk | Select-Object DeviceID, FreeSpace, Size | Out-File -Append -FilePath $perfTxt
